#!/usr/bin/python
# MMF simulator
# Copyright (C) 2015  Kumar Appaiah
...
def bandwidth_to_wavelength_range(maxf, L, steps = 10):
    ...
    array([1.55008009e-06, 1.55006229e-06, 1.55004449e-06, 1.55002669e-06,
           1.55000890e-06, 1.54999110e-06, 1.54997331e-06, 1.54995551e-06,
           1.54993772e-06, 1.54991992e-06])
    """
    fc = 3e8 / L
    minf_net = fc - maxf
    maxf_net = fc + maxf
